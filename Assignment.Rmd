...
<table>
<tr><td>
```{r pairs_plot, echo = FALSE, eval=TRUE, cache=TRUE, out.width='600px', out.height='500px'}
par(bg = "white")
...
```
<tr><td>
*Figure 2: Confusion matrix: caret/rpart*
</td>
</tr>
</table>
...
<tr><td>
*Figure 3: Confusion matrix: caret/lda*
</td></tr>
</table>
...
<tr><td>
*Figure 4: Confusion matrix: caret/gbm*
</td></tr>
</table>
...
<tr><td>
*Figure 5: Confusion matrix: caret/rf*
</td></tr>
</table>
